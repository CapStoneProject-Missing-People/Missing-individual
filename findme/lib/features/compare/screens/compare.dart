import 'dart:convert';
import 'package:findme/features/compare/data/fetchCompare.dart';
import 'package:flutter/material.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'package:http/http.dart' as http;
import 'package:findme/features/compare/model/compare-model.dart';
import 'package:findme/features/compare/screens/card-compare.dart'; // Import the card-compare.dart page
...
class _ComparePersonPageState extends State<ComparePersonPage> {
  ...
  Future<void> _validateAndCompare() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      if (response != null) {
        final matchedPerson = MatchedPersonAdd.fromJson(response);
        Navigator.push(
          context,
          MaterialPageRoute(
